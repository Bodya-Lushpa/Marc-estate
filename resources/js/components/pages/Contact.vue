        ...
        <div class="row">
          ...
          <div class="form-column col-lg-8 col-md-6 col-sm-12">
            <div class="inner-column">
              ...
              <formContact :csrf="csrf"></formContact>
            </div>
          </div>
            ...
            <div class="inner-column">
              ...
              <div class="contact-info-box">
                <div class="inner-box">
                  ...
                  <ul>
                    <li>
                      <a href="tel:+7 (777) 666 03 90">+7 (777) 666 03 90</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="contact-info-box">
                <div class="inner-box">
                  ...
                  <ul>
                    <li>
                      <a href="mailTo:info@markestate.kz">info@markestate.kz</a>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="contact-info-box follow-us">
                <div class="inner-box">
                  ...
                  <ul class="social-icon-three">
                    <li>
                      <a
                        href="https://instagram.com/mark.estate?igshid=Zjc2ZTc4Nzk="
                        ><span class="la la-instagram"></span
                      ></a>
                    </li>
                    <li>
                      <a
                        href="https://www.facebook.com/profile.php?id=100088668091336&mibextid=LQQJ4d"
