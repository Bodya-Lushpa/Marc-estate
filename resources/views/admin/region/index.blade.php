	...
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6 d-flex">
				<h1 class="m-0">Все регионы</h1>
				<a href="{{ route('region.create') }}" class="btn bg-gradient-success ml-4">Добавить</a>
			</div><!-- /.col -->
			<div class="col-sm-6">
						...
						<tr>
							...
							<td class="text-right">
								<div class="d-flex justify-content-end">
									<a href="{{ route('region.edit', $region['id']) }}" type="button" class="mr-2 btn btn-success toastsDefaultSuccess"><i class="fas fa-pen"></i></a>
